...
class Employee:
    def __init__(self, top=None):
        ...
        self.tree.heading("Aadhar No.", text="National ID", anchor=W)
        self.tree.heading("Password", text="Password", anchor=W)
        self.tree.heading("Designation", text="Role", anchor=W)
        ...
        if ename.strip():
            if valid_phone(econtact):
                if valid_aadhar(eaddhar):
                    ...
                    messagebox.showerror("Oops!", "Invalid National ID.", parent=e_add)
            else:
